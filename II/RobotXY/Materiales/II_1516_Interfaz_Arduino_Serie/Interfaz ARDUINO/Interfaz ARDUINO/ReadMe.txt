========================================================================
   APLICACIÓN: Interfaz ARDUINO Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación Interfaz ARDUINO.  

Este archivo incluye un resumen acerca del contenido de los archivos que 
constituyen su aplicación Interfaz ARDUINO.

Interfaz ARDUINO.vcxproj
...
Interfaz ARDUINO.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) denominado Interfaz ARDUINO.pch y un archivo de tipos 
